...
tables_cost = store[goods['Стол']][1]['quantity'] * store[goods['Стол']][0]['price']
# или проще (/сложнее ?)
...
sofas_cost = store[goods['Диван']][1]['quantity'] * store[goods['Диван']][0]['price']
# или проще (/сложнее ?)
...
chairs_cost = store[goods['Стул']][1]['quantity'] * store[goods['Стул']][0]['price']
# или проще (/сложнее ?)
